...
const { getUserProfile, updateUserProfile, uploadKycDocs, getVerifiedSuppliers, getVerificationStatusById } = require('../controllers/userController');
...
router.get('/verification-status/:id', authMiddleware, getVerificationStatusById);
