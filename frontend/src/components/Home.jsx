...
const products = [
  ...
  { 
    name: "Dosa Cart Pack",
    price: 900,
    supplier: "Bangalore Organic Hub",
    rating: 4.0,
    ratingCount: 89,
    image: "https://images.unsplash.com/photo-1519864600265-abb23847ef2c?auto=format&fit=crop&w=400&q=80",
    address: "Koramangala, Bangalore",
    delivery: "Shared Transport, Express Delivery",
    phone: "+91 98765 43211",
    verified: true,
    inStock: 8,
  },
  {
    name: "Tea Stall Bundle",
    price: 550,
    supplier: "Delhi Tea Traders",
    rating: 4.5,
    ratingCount: 203,
    image: "https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=400&q=80",
    address: "Chandni Chowk, Delhi",
    delivery: "Pickup, Local Delivery, Shared Transport",
    ...
    <div className="bg-gray-50 min-h-screen py-10">
      <div className="flex flex-wrap justify-center gap-8">
        {products.map((item, idx) => (
          <div
            key={idx}
            className="bg-white rounded-2xl shadow-lg w-96 flex flex-col"
          >
            <img
              src={item.image}
              alt={item.name}
            ...
            <div className="p-6 flex flex-col gap-3 flex-1">
              ...
              <div className="text-gray-700 font-medium">{item.supplier}</div>
              ...
              <div className="flex items-center gap-2 mt-4">
                <span className="text-green-700 font-semibold">{item.inStock} in stock</span>
                <button className="ml-auto bg-green-600 hover:bg-green-700 text-white text-base px-6 py-2 rounded-lg flex items-center gap-2 font-semibold shadow transition duration-150 cursor-pointer">
